...
def main():
    ...
    plt.figure(3)
    plt.imshow(vis)
    plt.imsave(os.path.join(main_path, 'results', 'fish_frequencies.png'), low_frequencies, dpi=95)
    plt.imsave(os.path.join(main_path, 'results', 'submarine_high_frequencies.png'), high_frequencies + 0.5, dpi=95)
    plt.imsave(os.path.join(main_path, 'results', 'fish_submarine_hybrid_image.png'), hybrid_image, dpi=95)
    plt.imsave(os.path.join(main_path, 'results', 'fish_submarine_hybrid_image_scales.png'), vis, dpi=95)
